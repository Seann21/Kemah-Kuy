            ...
            />
              <div className='flexBetween flex-col '>
                <div className='flex w-full flex-col'>
                  ...
                  <p className='bold-20 mt-2'>Danau Semeru</p>
                </div>
                <div className='flex w-full flex-col'>
                      <p className='regular-16 text-gray-20'>Mulai Perjalanan</p>
                  <h4 className='bold-20 mt-2 whitespace-nowrap'>Kota Lumajang</h4>
                </div>
              </div>
          </div>
